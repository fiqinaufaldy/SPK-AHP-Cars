...
<head>
	<meta charset="UTF-8">
	<title>Sistem Pendukung Keputusan Untuk Menentukan Pembelian Mobil</title>
...
<body>
<header>
	<h1>Sistem Pendukung Keputusan Untuk Menentukan Pembelian Mobil Dengan Metode AHP</h1>
</header>
...
<div class="wrapper">
	<nav id="navigation" role="navigation">
		<ul>
			...
			<li>
				<a class="item" href="alternatif.php">Mobil
			...
			<li><a class="item" href="bobot.php?c=1">Perbandingan Mobil</a></li>
				<ul>
					<?php
