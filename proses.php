...
if (isset($_POST['submit'])) {
	...
	// cek konsistensi
	$eigenvektor = $jmlmpb !== 0 && $jmlmnk !== 0 && $n !== 0 ? getEigenVector($jmlmpb, $jmlmnk, $n) : null;
	$consIndex = $jmlmpb !== 0 && $jmlmnk !== 0 && $n !== 0 ? getConsIndex($jmlmpb, $jmlmnk, $n) : null;
	$consRatio = $jmlmpb !== 0 && $jmlmnk !== 0 && $n !== 0 ? getConsRatio($jmlmpb, $jmlmnk, $n) : null;
